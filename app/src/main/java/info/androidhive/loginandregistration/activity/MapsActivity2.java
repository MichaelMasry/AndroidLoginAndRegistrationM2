...
public class MapsActivity2 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotonearLoc = findViewById(R.id.goToNearByLocations);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        getLocationPermission();
        gotonearLoc.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            mMap.addMarker(new MarkerOptions().position(new LatLng(currentLocation.getLatitude()
                                    ,currentLocation.getLongitude())).title("Your Location").icon(
    ...
    private void moveCamera(LatLng latLng){
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, MapsActivity2.DEFAULT_ZOOM));
    }
